...
<main>
    ...
    <section class="header-video">
        ...
        <img src="{{asset('theme/images/img-video_fix.png')}}" alt="" class="header-video--media dark-overlay" data-video-src="{{url('/')}}/uploads/video/tz" data-teaser-source="{{url('/')}}/uploads/video/tz" data-provider="" data-video-width="1920" data-video-height="960">
    </section>
    <!--/hero_in-->
    ...
    <div class="bg_color_1">
        <div class="container margin_80_55">
            <div class="main_title_2">
                <span><em></em></span>
                <h2 class="bg-white">{{$Settings->sitename}} Explore Tanzania</h2><br>
    ...
    <div class="container container-custom margin_30_95">
        <section class="add_bottom_45">
            <div class="main_title_3">
                ...
                <p>Tanzania has lots of amazing places to visit, We have handpicked some of the best places possible just for you</p>
                <br>
            </div>
            <div class="row">
        ...
        <section class="add_bottom_45">
            <div class="main_title_3">
                ...
                <p>More Stuff about Tanzania goes here</p>
            </div>
        </section>
        <!-- /section -->
