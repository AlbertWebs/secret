   ...
   <!-- PAGE CONTENT --> 
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <form class="form-signin" method="POST" action="{{ route('principal.login.submit') }}">
                        {{ csrf_field() }}
        ...
        <div id="forgot" class="tab-pane">
            <form method="POST" action="{{ route('principal.password.email') }}" class="form-signin">
            {{ csrf_field() }}
